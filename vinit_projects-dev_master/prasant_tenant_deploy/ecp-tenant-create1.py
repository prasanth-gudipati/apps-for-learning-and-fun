...
if __name__ == '__main__':
    ...
    parser.add_argument('-ip',
                        help='ecp_ip', default='10.40.226.25')
    parser.add_argument('-user',
                        help='user', default='script1pgudipati')
    ...
    payload2_tb263 = {  "name": "{{tenant_name}}",
                         "version": "1",
                         "sdwanEnabled": "false",
                         "saseProductInfo": {
                             "usageType": "BANDWIDTH",
                             ...
                             "bundleType": "VERSA_SASE_PROFESSIONAL_BUNDLE",
                             "disableDAI": "true",
                             "bandwidthAddons": [
                                 "API_DATA_PROTECTION",
                         ...
                         "originalStatus": {
                             "status": "true",
                             "roles": [
                                 "e1543742-6ab9-4747-a2c3-675a33ecf195",
                                 "a94a8ce9-d15a-47ea-9f17-62ccae498cab",
                                 "59fc7a74-8a28-4803-b52a-afa9ef2403b0",
                                 "c5bba055-efe3-40ff-ae6f-02dca35de529"
                             ]
                         },
                         "parentTenantUUID": "0781aae8-b206-4a8a-bda2-a69b2a73fe3a",
                         "directors": [
                             "f66ea2c8-821c-41c0-a67e-46d9f72d0e45"
                         ],
                         "status": "true",
                         "controllers": [
                             "1013da01-d9a5-4bb9-b976-fc1ebb49e626",
                             "3ad47856-0b23-486e-b360-394524e077f0"
                         ],
                         "roles": [
                             "e1543742-6ab9-4747-a2c3-675a33ecf195",
                             "a94a8ce9-d15a-47ea-9f17-62ccae498cab",
                         ...
                         "defaultDirector": "f66ea2c8-821c-41c0-a67e-46d9f72d0e45",
                         "authenticationType": "PSK",
                         "ztpType": "SERIAL_NO",
                         "saseEnabled": "true",
                         "mSPEnabled": "false",
                         ...
                         "regionInfos": [
                             {
                                 "regionName": "Reg100-West",
                                 "regionUUID": "829c850b-b32b-4402-99ef-725c1c4aad65",
                                 "selected": "true",
                                 "selectedGateways": [
                                     {
                                         "saseGatewayUUID": "ac7c32c9-bbfc-4f1a-9a32-70ccf4478ac8",
                                         "gatewayName": "SASE61-br6-tb263",
                                         "tenantCount": 1,
                                         "portalEnabled": "true",
                                         "tenantSaseGatewayVPNInfos": [
                                             {
    ...
    template = Template(json.dumps(payload2_tb263,indent=4))
    json_data = template.render(tenant_name='Demo5')
