...
if __name__ == '__main__':
    ...
    parser.add_argument('-ip',
                        help='ecp_ip',default='10.43.70.72')
    parser.add_argument('-user',
                        help='user',default='pgudipati')
    parser.add_argument('-password',
                        help='password',default='Versa@123')
    ...
    payload = {
                ...
                "parentTenantUUID": "126056ad-61ad-4460-b899-ef21accce8ee",
                "directors": [
    ...
    payload2 = {
    "name": "Tenant-Jan2025-002",
    "version": "1",
    "sdwanEnabled": False,
    "saseProductInfo": {
        "usageType": "BANDWIDTH",
        "bandwidthValue": 1000,
        "saseProductTypeMode": "BUNDLE",
        "bundleType": "VERSA_SASE_ELITE_BUNDLE",
        "disableDAI": False,
        "fwLogs": "ANALYTICS",
        "webLogs": "ANALYTICS",
        "dnsLogs": "ANALYTICS",
        "cgnatLogs": "ANALYTICS",
        "addonsAdditionalInfo": {
            "value": {
                "featureInfos": [
                    {
                        ...
                        "regionInfo": {
                            "name": "Default",
                            "uuid": "52b1db9f-2135-4888-8cb9-aba18619931a"
                        }
                    }
                ]
            },
            "type": "SASE_PRODUCT_ADDONS_ADDITIONAL_INFO"
        }
    },
    "originalStatus": {
        "status": True,
        "roles": [
            "9a17f649-cdf3-454a-93c7-e9f252a0172a",
            "7e58b20d-121c-4425-91ea-f19a947473d2",
            "2dcccff1-cd67-4e85-b576-2e060947f373",
            "bb04f4b2-cae4-4734-8931-379fbbc2e583"
        ]
    },
    "parentTenantUUID": "126056ad-61ad-4460-b899-ef21accce8ee",
    "directors": [
        "b7557f62-5c88-4a9c-9c9b-756e703fc29a"
    ],
    "status": True,
    "controllers": [
        "e0a15376-eca0-4021-96f1-fa2f4491548c",
        "4157112c-f3a7-4c50-8866-b8f013c008d3"
    ],
    "roles": [
        "9a17f649-cdf3-454a-93c7-e9f252a0172a",
        "7e58b20d-121c-4425-91ea-f19a947473d2",
    ...
    "defaultDirector": "b7557f62-5c88-4a9c-9c9b-756e703fc29a",
    "authenticationType": "PSK",
    "ztpType": "SERIAL_NO",
    "saseEnabled": True,
    "mSPEnabled": False,
    ...
    "regionInfos": [
        {
            "regionName": "Default",
            "regionUUID": "52b1db9f-2135-4888-8cb9-aba18619931a",
            "selectedGateways": [
                {
                    "saseGatewayUUID": "a5438cc6-5c25-4e50-b262-606e594aeedd",
                    "gatewayName": "SASE-GW-Br1",
                    "tenantCount": 1,

                    "portalEnabled": True,
                    "tenantSaseGatewayVPNInfos": [
                        {
                            "vpnName": "Tenant-Jan2025-002-Enterprise",
                            "tenantSaseGatewayVPNClientPoolInfos": [
                                {
                                    "poolName": "Pool-1",
                                    "poolPrefix": "10.11.1.0/24"
                                }
                            ]
                        }
                    ],
    ...
    "parentTenantUUID": "{{ parent_Tenant_UUID }}",
    "directors": [
        "b7557f62-5c88-4a9c-9c9b-756e703fc29a"
    ],
    "status": True,
    "defaultDirector": "default_Director_UUID",
    "authenticationType": "PSK",
    "ztpType": "SERIAL_NO",
    "saseEnabled": True,
    "mSPEnabled": False,
    ...
    "regionInfos": [
        {
            "regionName": "Default",
            "regionUUID": "{{ default_region_uuid }}",
            "selectedGateways": [
                {
                    "saseGatewayUUID": "{{ gw1_uuid }}",
                    "gatewayName": "{{ g1_name_uuid }}",
                    "tenantCount": 1,

                    "portalEnabled": True,
                    "tenantSaseGatewayVPNInfos": [
                        {
                            "vpnName": "{{ tenant_name }}-Enterprise",
                            "tenantSaseGatewayVPNClientPoolInfos": [
                                {
                                    "poolName": "Pool-1",
                                    "poolPrefix": "10.11.1.0/24"
    ...
    template = Template(json.dumps(payload2,indent=4))
    json_data = template.render(tenant_name='t-scl3tb-13jan25')
